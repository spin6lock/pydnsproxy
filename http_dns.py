...
def unpack_dns_header(rawstr):
    ...
    start += HEADER_SIZE
    QDCOUNT, ANCOUNT, NSCOUNT, ARCOUNT = struct.unpack(">hhhh", rawstr[start:start+COUNT_FIELD_SIZE])
...
def test_http_dns():
    result = "038b818000010001000000000377777706616d617a6f6e03636f6d00c00c000100010000003c0004b02067cd".decode("hex")
